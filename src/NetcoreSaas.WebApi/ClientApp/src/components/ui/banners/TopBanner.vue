        ...
        <div class="flex-grow">
          <div class="flex sm:hidden">
            <div class="w-full">
              ...
              >
                <option :value="0">Vue2 + Tailwind CSS + .NET</option>
                <option selected :value="1">Vue3 + Tailwind CSS + .NET</option>
                <option :value="2">React + Tailwind CSS + .NET</option>
                <option :value="3">Svelte + Tailwind CSS + .NET</option>
              </select>
            </div>
          </div>
