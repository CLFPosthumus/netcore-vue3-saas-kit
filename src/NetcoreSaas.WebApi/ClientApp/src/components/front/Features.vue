  ...
  <div>
        ...
        >
          <div class="relative">
            ...
            <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
              <img
                alt="Components"
                class="w-full h-20 shadow-lg border border-gray-200 dark:border-slate-800 rounded-md object-cover"
              ...
              <div>
                ...
                >{{ $t("front.features.frontend.components.viewAll") }}</router-link>
              </div>
            </dd>
          </div>
          ...
          <div class="relative">
            ...
            <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
              ...
              <div>
                ...
                <a
                  href="https://saasfrontends.com/views"
                  to="/components"
                  class="underline text-theme-500 font-medium"
          ...
          <div class="relative">
            ...
            <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
              <img
                alt="vue3-setup-script"
                class="w-full h-20 shadow-lg border border-gray-200 dark:border-slate-800 rounded-md object-cover"
                src="https://yahooder.sirv.com/saasfrontends/features/vue3-setup-script.jpg"
              />
          ...
          <div class="relative">
            ...
            <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
              <img
                alt="ESLint"
                class="w-full h-20 shadow-lg border border-gray-200 dark:border-slate-800 rounded-md object-cover"
                src="https://yahooder.sirv.com/saasfrontends/features/vue3-eslint.jpg"
              />
              <div>
    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
      <div>
        <h2
          class="text-base font-semibold text-theme-600 uppercase tracking-wide"
        >{{ $t("front.features.backend.hint") }}</h2>
        <p class="mt-2 text-3xl font-extrabold">{{ $t("front.features.backend.title") }}</p>
        <p class="mt-4 text-lg text-gray-500">{{ $t("front.features.backend.description") }}</p>
      </div>
      <div class="mt-12 lg:mt-0 lg:col-span-2">
        <dl
          class="space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:grid-rows-4 sm:grid-flow-col sm:gap-x-6 sm:gap-y-10 lg:gap-x-8"
        >
          <div class="relative">
            <dt>
              ...
              <p
                class="ml-9 text-lg leading-6 font-medium"
              >{{ $t("front.features.backend.features.net.title") }}</p>
            </dt>
            <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
              <img
                alt=".NET"
          ...
          <div class="relative">
            <dt>
              ...
              <p
                class="ml-9 text-lg leading-6 font-medium"
              >{{ $t("front.features.backend.features.cleanArchitecture.title") }}</p>
            </dt>
            <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
              <img
          ...
          <div class="relative">
            <dt>
              ...
              <p
                class="ml-9 text-lg leading-6 font-medium"
              >{{ $t("front.features.backend.features.tests.title") }}</p>
            </dt>
            <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
              <img
                alt="Tests"
          ...
          <div class="relative">
            <dt>
              ...
              <p
                class="ml-9 text-lg leading-6 font-medium"
              >{{ $t("front.features.backend.features.multiTenant.title") }}</p>
            </dt>
            <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
              <img
                alt="Multi-Tenancy"
          ...
          <div class="relative">
            <dt>
              ...
              <p
                class="ml-9 text-lg leading-6 font-medium"
              >{{ $t("front.features.backend.features.memberManagement.title") }}</p>
            </dt>
            <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
              <img
                alt="Components"
          ...
          <div class="relative">
            <dt>
              ...
              <p
                class="ml-9 text-lg leading-6 font-medium"
              >{{ $t("front.features.backend.features.stripe.title") }}</p>
            </dt>
            <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
              <img
                alt="Components"
              ...
              <div>
                ...
                <router-link
                  to="/admin/pricing"
                  class="underline text-theme-500 font-medium"
                >{{ $t("front.features.backend.features.stripe.setup") }}</router-link>
              </div>
            </dd>
          </div>
          ...
          <div class="relative">
            <dt>
              ...
              <p
                class="ml-9 text-lg leading-6 font-medium"
              >{{ $t("front.features.backend.features.postmark.title") }}</p>
            </dt>
            <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
              <img
                alt="Components"
              ...
              <div>
                ...
                <router-link
                  to="/admin/emails"
                  class="underline text-theme-500 font-medium"
                >{{ $t("front.features.backend.features.postmark.setup") }}</router-link>
              </div>
            </dd>
          </div>
          ...
          <div class="relative">
            <dt>
              ...
              <p
                class="ml-9 text-lg leading-6 font-medium"
              >{{ $t("front.features.backend.features.ef.title") }}</p>
            </dt>
            <dd class="mt-2 ml-9 text-base text-gray-500 space-y-3">
              <img
                alt="Components"
