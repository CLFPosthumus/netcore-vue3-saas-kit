    ...
    <div class="bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:flex-col sm:align-center">
          <div class="relative mx-auto py-12 sm:py-6 w-full">
            <svg
            ...
            <div class="text-center">
              ...
              >{{ $t("admin.components.title") }}</h2>
              <p class="mt-4 text-lg leading-6 text-gray-500">{{ $t("admin.components.headline") }}</p>
            </div>
            <div class="mt-12">
              <AllComponentsList />
            </div>
...
useMeta({ title: i18n.global.t("admin.components.title").toString() })
