      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:flex-col sm:align-center space-y-4">
          <div class="text-gray-500 prose mx-auto">
            ...
            >{{ $t("front.privacy.title") }}</h1>
            <p>
              Your privacy is important to us. It is SaasFrontends&#39; policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website,
              <a
                class="text-black dark:text-white"
                href="https://saasfrontends.com"
              >https://saasfrontends.com</a>, and other sites we own and operate.
            </p>
            <p>This policy is effective as of 14 December 2021 and was last updated on 14 December 2021.</p>
            <h3 class="text-black dark:text-white">Information We Collect</h3>
            ...
            <h4 class="text-black dark:text-white">Log Data</h4>
            ...
            <h4 class="text-black dark:text-white">Collection and Use of Information</h4>
            ...
            <h4 class="text-black dark:text-white">Security of Your Personal Information</h4>
            ...
            <h4 class="text-black dark:text-white">How Long We Keep Your Personal Information</h4>
            ...
            <h3 class="text-black dark:text-white">Children’s Privacy</h3>
            ...
            <h3
              class="text-black dark:text-white"
            >Disclosure of Personal Information to Third Parties</h3>
            ...
            <h3 class="text-black dark:text-white">International Transfers of Personal Information</h3>
            ...
            <h3
              class="text-black dark:text-white"
            >Your Rights and Controlling Your Personal Information</h3>
            ...
            <h3 class="text-black dark:text-white">Use of Cookies</h3>
            ...
            <h3 class="text-black dark:text-white">Limits of Our Policy</h3>
            <p>Our website may link to external sites that are not operated by us. Please be aware that we have no control over the content and policies of those sites, and cannot accept responsibility or liability for their respective privacy practices.</p>
            <h3 class="text-black dark:text-white">Changes to This Policy</h3>
            ...
            <h3 class="text-black dark:text-white">Contact Us</h3>
            <p>For any questions or concerns regarding your privacy, you may contact us using the following details:</p>
            <p>
              Alexandro Martinez
              <br />contact@saasfrontends.com
            </p>
          </div>
        </div>
      </div>
...
export default defineComponent({
  ...
  setup() {
    useMeta({ title: i18n.global.t("front.privacy.title") })
  }
})
</script>
