<template>
  <div class="justify-center md:flex md:space-x-2 pt-5 px-3 mx-auto max-w-2xl">
    <h1
      class="text-lg font-bold mx-auto mt-1 p-1 justify-center items-center flex w-full"
    >{{ $t("shared.unauthorized") }}</h1>
    <div
      class="max-w-md mx-auto px-4 lg:px-10 flex justify-center py-4 md:py-8 lg:py-12 rounded-sm text-center flex-col"
    >
      <svg
      ...
      >
        ...
        <path
          ...
          opacity="0.1"
        />
        <ellipse cx="120.3" cy="728.81" rx="88.28" ry="14.18" fill="#343450" opacity="0.1" />
        <ellipse cx="912.26" cy="804.71" rx="156.53" ry="15.2" fill="#343450" opacity="0.1" />
        <rect
          x="116.14"
          y="107.75"
          width="950.33"
        ...
        <rect x="195.68" y="181.67" width="254.25" height="21.58" fill="#343450" opacity="0.2" />
...
useMeta({
  title: $t("shared.unauthorized").toString()
})
</script>
